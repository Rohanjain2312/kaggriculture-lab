...
# --------------------------------------------------------------------------- #
# PANEL OPPONENT -- build copied from "THUNDER THUNDER"
# --------------------------------------------------------------------------- #
# Extracted by panel.py from 4 digested 1.32.6 season(s);
# that competitor averaged $79,798. Only the four strategic
...
PANEL_NAME = 'THUNDER THUNDER'
SCRIPT_HANDS = [4, 0, 1, 2, 4, 3, 3, 7, 7, 6, 12, 10, 9, 8, 9, 11, 12, 11, 12, 12, 14, 14, 12, 14, 14, 13, 12, 10, 10, 10]
SCRIPT_LAND = {7: 2, 11: 3}
SCRIPT_HERD = {'COW': 8, 'SHEEP': 6}
SCRIPT_PLANT = {1: [('WHEAT', 2), ('MELON', 4)], 3: [('STRAWBERRY', 1)], 4: [('WHEAT', 1), ('STRAWBERRY', 2)], 5: [('WHEAT', 1)], 6: [('STRAWBERRY', 4)], 7: [('STRAWBERRY', 5)], 8: [('WHEAT', 4), ('STRAWBERRY', 5)], 9: [('WHEAT', 2), ('STRAWBERRY', 2)], 10: [('STRAWBERRY', 2)], 11: [('STRAWBERRY', 8), ('MELON', 7)], 12: [('STRAWBERRY', 7), ('MELON', 3)], 19: [('WHEAT', 1)], 20: [('WHEAT', 6)], 21: [('WHEAT', 4)], 22: [('WHEAT', 6)], 23: [('WHEAT', 4)], 24: [('WHEAT', 6)], 25: [('WHEAT', 2)], 26: [('WHEAT', 4)], 27: [('WHEAT', 1)]}
